...
<body class="bg-brand-dark text-white min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-stone-900/90 border border-brand-gold/30 rounded-3xl p-8 sm:p-10 shadow-2xl backdrop-blur-md space-y-8">
        
        <!-- Header Logo -->
        <div class="text-center space-y-2">
            <div class="w-16 h-16 rounded-full border border-brand-gold/50 mx-auto flex items-center justify-center bg-brand-dark shadow-inner">
            ...
            <p class="text-[10px] tracking-[0.3em] text-brand-gold uppercase font-semibold">ADMINISTRATOR CONTROL PANEL</p>
        </div>
        ...
        @if(session('success'))
            <div class="bg-emerald-900/60 border border-emerald-500/50 text-emerald-200 text-xs p-4 rounded-xl text-center">
                {{ session('success') }}
            </div>
        @endif
        ...
        <form action="{{ url('/admin/login') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label class="block text-[11px] font-semibold text-stone-400 uppercase tracking-wider mb-1.5">Email Admin</label>
            ...
            <div>
                <label class="block text-[11px] font-semibold text-stone-400 uppercase tracking-wider mb-1.5">Kata Sandi (Password)</label>
        ...
        <div class="text-center pt-2">
            <p class="text-[10px] text-stone-500 tracking-wider">Default Login: admin@waewatu.com | adminpassword123</p>
        </div>
    </div>
